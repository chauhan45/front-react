...
import building2 from "../../assets/img/illustrations/RenovationImage1.jpg";
...
export const Renovation = () => {
    ...
    return (
        <>
            <section id="Renovation" className=" pt-4 pt-md-11 pt-40 pb-30 mb-50">
                <h1 className="text-center Construction_text mb-20 pt-xs-100 mb-100 RenovationText">Renovation</h1>
