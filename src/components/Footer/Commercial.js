...
import building2 from "../../assets/img/illustrations/CommercialImage.jpg";
...
export const Commercial = () => {
    ...
    return (
        <>
            <section id="Commercial" class="pt-4 pt-md-11 pt-40 pb-30 mb-50 ">
            <h1 className="text-center Construction_text mb-20 pt-xs-100 mb-100 CommercialText ">Commercial</h1>
